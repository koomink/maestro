...
- 획득: 같은 키의 리스가 **없을 때만**. 짧은 `writer_lock` 안의 단일 트랜잭션
- 해제: 집행 완료 또는 중단 시. 그리고 **오직 그때만**
...
**따라서 리스 차단은 반드시 알림을 동반해야 한다.** 조용히 막는 것은 교착보다 나을 게 없다. 차단된 승인은 즉시 운영자에게 통지하고, 소유자와 경과 시간을 함께 전달한다.
