...
날짜: 2026-08-09
상태: 단계 1·2 구현 완료, 3a-1·3a-2·3a-3(범위 A) 구현 완료 (2026-08-15 기준).
남은 단계: 4a, 3a-4·3a-5, 3b, 4b, 5 — 아래 「마이그레이션 순서」 표 참조
...
| **4a** | **배치 집행 결과 분류 + 승인 종결 (CLI)** — 「C-1」 참조. 3a-4·3b보다 **먼저** 간다 | 닫지 못하는 승인 2건을 닫고, 4b·3a-5의 토대가 된다 |
