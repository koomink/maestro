...
날짜: 2026-08-09
상태: 단계 1·2 구현 완료, 3a-1·3a-2 구현 완료 (2026-08-14 기준).
남은 단계: 3a-3·3a-4·3a-5, 3b, 4, 5 — 아래 「마이그레이션 순서」 표 참조
...
| 3a (1·2 완료) | **정합성 기반 작업 (UI 아님, 접근 A 예외)**: StateStore 원자 커밋 API, 워크플로우 head/CAS, attempt 기반 claim·재개, lineage, dispatch idempotent resume, 승인 결정 2단계 영속화, 수렴 sweep | 기존 교체 경합·중단 복구 결함 해소 (독립 배포·검증) |
